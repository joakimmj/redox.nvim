...
function M.set_colors(colors)
  ...
  vim.api.nvim_set_hl(0, "PreCondit", { link = "@keyword" })
  vim.api.nvim_set_hl(0, "String", { link = "@string" })
  vim.api.nvim_set_hl(0, "Character", { link = "@string" })
  vim.api.nvim_set_hl(0, "Number", { link = "@number" })
  vim.api.nvim_set_hl(0, "Boolean", { link = "@boolean" })
  vim.api.nvim_set_hl(0, "Float", { link = "@number" })
  vim.api.nvim_set_hl(0, "Delimiter", { link = "@punctuation.special" })
  ...
  vim.api.nvim_set_hl(0, "SpellBad", { bg = colors.diff_delete, underline = true, sp = colors.red })
  vim.api.nvim_set_hl(0, "SpellCap", { bg = colors.diff_change, underline = true, sp = colors.warn })
  vim.api.nvim_set_hl(0, "SpellRare", { underline = true, sp = colors.warn })
  vim.api.nvim_set_hl(0, "SpellLocal", { underline = true, sp = colors.info })
